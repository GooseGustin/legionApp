...
class Praesidium(models.Model):
    ...
    curia = models.ForeignKey(Curia, on_delete=models.CASCADE, related_name="associated_praesidium")
    ...
    managers = models.ManyToManyField(Legionary, related_name="praesidia_managed")
    members = models.ManyToManyField(Legionary, related_name="associated_praesidia")
    membership_requests = models.ManyToManyField(Legionary, related_name="praesidia_membership_requests")
    management_requests = models.ManyToManyField(Legionary, related_name="praesidia_management_requests")
